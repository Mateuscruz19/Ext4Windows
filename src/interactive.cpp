...
static void do_scan_partitions()
{
    ...
    if (is_elevated()) {
        bdev = create_partition_blockdev(part.device_path.c_str(), read_only);
    } else {
        HANDLE h = open_device_elevated(part.device_path.c_str(), read_only);
    ...
    if (!bdev) {
        set_color(CLR_RED);
        printf("\n\n  %s\n", tr(
            "Error: could not open partition.",
            "Erro: nao foi possivel abrir a particao.",
            "Error: no se pudo abrir la particion.",
            "Fehler: Partition konnte nicht geoffnet werden.",
            "Erreur: impossible d'ouvrir la partition.",
            "\xe9\x94\x99\xe8\xaf\xaf: \xe6\x97\xa0\xe6\xb3\x95\xe6\x89\x93\xe5\xbc\x80\xe5\x88\x86\xe5\x8c\xba\xe3\x80\x82",
            "\xe3\x82\xa8\xe3\x83\xa9\xe3\x83\xbc: \xe3\x83\x91\xe3\x83\xbc\xe3\x83\x86\xe3\x82\xa3\xe3\x82\xb7\xe3\x83\xa7\xe3\x83\xb3\xe3\x82\x92\xe9\x96\x8b\xe3\x81\x91\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xe3\x80\x82",
        "\xd0\x9e\xd1\x88\xd0\xb8\xd0\xb1\xd0\xba\xd0\xb0: \xd0\xbd\xd0\xb5 \xd1\x83\xd0\xb4\xd0\xb0\xd0\xbb\xd0\xbe\xd1\x81\xd1\x8c \xd0\xbe\xd1\x82\xd0\xba\xd1\x80\xd1\x8b\xd1\x82\xd1\x8c \xd1\x80\xd0\xb0\xd0\xb7\xd0\xb4\xd0\xb5\xd0\xbb."));
        reset_color();
        return;
    }

    Ext4FileSystem fs;
    wchar_t mount_point[4] = { (wchar_t)drive_letter, L':', L'\0' };
    NTSTATUS status = fs.Mount(bdev, mount_point, read_only, (char)drive_letter);
    if (!NT_SUCCESS(status)) {
        set_color(CLR_RED);
        printf("\n\n  %s (0x%08lX)\n", tr(
            "Error: mount failed",
            "Erro: falha ao montar",
            "Error: fallo el montaje",
            "Fehler: Mount fehlgeschlagen",
            "Erreur: echec du montage",
            "\xe9\x94\x99\xe8\xaf\xaf: \xe6\x8c\x82\xe8\xbd\xbd\xe5\xa4\xb1\xe8\xb4\xa5",
            "\xe3\x82\xa8\xe3\x83\xa9\xe3\x83\xbc: \xe3\x83\x9e\xe3\x82\xa6\xe3\x83\xb3\xe3\x83\x88\xe5\xa4\xb1\xe6\x95\x97",
        "\xd0\x9e\xd1\x88\xd0\xb8\xd0\xb1\xd0\xba\xd0\xb0: \xd0\xbc\xd0\xbe\xd0\xbd\xd1\x82\xd0\xb8\xd1\x80\xd0\xbe\xd0\xb2\xd0\xb0\xd0\xbd\xd0\xb8\xd0\xb5 \xd0\xbd\xd0\xb5 \xd1\x83\xd0\xb4\xd0\xb0\xd0\xbb\xd0\xbe\xd1\x81\xd1\x8c"), status);
        reset_color();
    ...
    set_color(CLR_GREEN);
    printf("\n\n  OK! %s %c: (%s)\n",
        tr("Mounted on", "Montado em", "Montado en",
           "Gemountet auf", "Monte sur",
           "\xe5\xb7\xb2\xe6\x8c\x82\xe8\xbd\xbd\xe5\x88\xb0",
           "\xe3\x83\x9e\xe3\x82\xa6\xe3\x83\xb3\xe3\x83\x88\xe5\x85\x88",
        "\xd0\xa1\xd0\xbc\xd0\xbe\xd0\xbd\xd1\x82\xd0\xb8\xd1\x80\xd0\xbe\xd0\xb2\xd0\xb0\xd0\xbd\xd0\xbe \xd0\xbd\xd0\xb0"),
        drive_letter,
        read_write
            ? tr("read-write", "leitura e escrita",
                 ...
                 "\xe8\xaf\xbb\xe5\x86\x99",
                 "\xe8\xaa\xad\xe3\x81\xbf\xe6\x9b\xb8\xe3\x81\x8d",
        "\xd1\x87\xd1\x82\xd0\xb5\xd0\xbd\xd0\xb8\xd0\xb5/\xd0\xb7\xd0\xb0\xd0\xbf\xd0\xb8\xd1\x81\xd1\x8c")
        ...
        "\xd1\x82\xd0\xbe\xd0\xbb\xd1\x8c\xd0\xba\xd0\xbe \xd1\x87\xd1\x82\xd0\xb5\xd0\xbd\xd0\xb8\xd0\xb5"));
    reset_color();

    set_color(CLR_GRAY);
    printf("  %s\n", tr(
        "WARNING: Closing this window will unmount the partition.",
        "AVISO: Fechar esta janela vai desmontar a particao.",
        "AVISO: Cerrar esta ventana desmontara la particion.",
        "WARNUNG: Das Schliessen dieses Fensters unmountet die Partition.",
        "ATTENTION: Fermer cette fenetre demontera la partition.",
        "\xe8\xad\xa6\xe5\x91\x8a: \xe5\x85\xb3\xe9\x97\xad\xe6\xad\xa4\xe7\xaa\x97\xe5\x8f\xa3\xe5\xb0\x86\xe5\x8d\xb8\xe8\xbd\xbd\xe5\x88\x86\xe5\x8c\xba\xe3\x80\x82",
        "\xe8\xad\xa6\xe5\x91\x8a: ",
        "\xd0\x92\xd0\x9d\xd0\x98\xd0\x9c\xd0\x90\xd0\x9d\xd0\x98\xd0\x95: \xd0\x97\xd0\xb0\xd0\xba\xd1\x80\xd1\x8b\xd1\x82\xd0\xb8\xd0\xb5 \xd0\xbe\xd0\xba\xd0\xbd\xd0\xb0 \xd1\x80\xd0\xb0\xd0\xb7\xd0\xbc\xd0\xbe\xd0\xbd\xd1\x82\xd0\xb8\xd1\x80\xd1\x83\xd0\xb5\xd1\x82 \xd1\x80\xd0\xb0\xd0\xb7\xd0\xb4\xd0\xb5\xd0\xbb."));
    reset_color();

    // Keep the fs alive by leaking it (partition mounts live in this process)
    auto* leaked_fs = new Ext4FileSystem(std::move(fs));
    (void)leaked_fs;
}
