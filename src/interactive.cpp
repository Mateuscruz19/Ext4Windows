...
static void do_mount_image()
{
    ...
    if (free) {
        printf("  %s [%c]:\n", tr(
            ...
            "\xe3\x83\x89\xe3\x83\xa9\xe3\x82\xa4\xe3\x83\x96\xe6\x96\x87\xe5\xad\x97? Enter\xe3\x81\xa7\xe8\x87\xaa\xe5\x8b\x95"), free);
    } else {
        printf("  %s:\n", tr(
...
static void do_scan_partitions()
{
    ...
    if (!NT_SUCCESS(status)) {
        ...
        printf("\n\n  %s (0x%08lX)\n", tr(
            ...
            "\xe3\x82\xa8\xe3\x83\xa9\xe3\x83\xbc: \xe3\x83\x9e\xe3\x82\xa6\xe3\x83\xb3\xe3\x83\x88\xe5\xa4\xb1\xe6\x95\x97"), status);
        reset_color();
